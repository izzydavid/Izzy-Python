...
class MainApp(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(
            self.sidebar_frame,
            command=self.app_functions.sidebar_button_event)
        ...
        self.appearance_mode_optionemenu = customtkinter.CTkOptionMenu(
            ...
            command=self.app_functions.change_appearance_mode_event)
        ...
        self.scaling_optionemenu = customtkinter.CTkOptionMenu(
            ...
            command=self.app_functions.change_scaling_event)
        ...
        self.string_input_button = customtkinter.CTkButton(
            ...
            command=self.app_functions.open_input_dialog_event)
        ...
        for i in range(100):
            switch = customtkinter.CTkSwitch(master=self.scrollable_frame,
                                             text=f"CTkSwitch {i}")
        ...
        #self.slider_1.configure(command=self.app_functions.progressbar_2.set)
        #self.slider_2.configure(command=self.app_functions.progressbar_3.set)
